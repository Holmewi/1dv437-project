...
namespace Hypothermia.Model.Levels
{
    public class Level1 : Level
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            {
                sb.DrawString(this.font, "Level 1", this.camera.GetDeviceCoordinates(0, 0), Color.Black);
            ...
            else if (base.LevelState == LevelState.Finished) 
            {
                this.DrawBackground(sb);
                this.DrawForeground(sb);
                sb.DrawString(this.font, "Completed Level 1, Press Enter to continue", this.camera.GetDeviceCoordinates(0, 0), Color.Black);
            }
        }
